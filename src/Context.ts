...
export class Context extends THREE.EventDispatcher {
    ...
    public addMarker(arMarkerControls: MarkerPositioning) {
        this._arMarkerControls.push(arMarkerControls);
    }

    public removeMarker(arMarkerControls: MarkerPositioning) {
