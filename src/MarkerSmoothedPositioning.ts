...
export class MarkerSmoothedPositioning extends BasePositioning {
    ...
    public setParameters(parameters: MarkerSmoothedPositioningParameters) {
        if (!parameters) {
            return;
        }
    ...
    public update(targetObject3d: Object3D) {
        ...
        const applyOneSlerpStep = () => {
            this.object3d.position.lerp(
                targetObject3d.position,
                parameters.lerpPosition
            );
            this.object3d.quaternion.slerp(
                targetObject3d.quaternion,
                parameters.lerpQuaternion
            );
            this.object3d.scale.lerp(
                targetObject3d.scale,
                parameters.lerpScale
            );
        };
