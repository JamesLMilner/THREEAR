export declare class ARToolkit {
    ...
    static setDebugMode: (id: number, mode: boolean) => any;
    ...
    static getTransMatSquareCont: (id: any, markerUID: number, markerWidth: any) => any;
    ...
    static loadCamera(url: any, callback: any, onerror: any): void;
    static getFrameMalloc(): any;
    static runtimeLoad(): void;
    static addMarker(arId: any, url: any, callback: any, onError: any): void;
    static addNFTMarker(arId: any, url: any, callback: any): void;
    static bytesToString(array: any): any;
    static parseMultiFile(bytes: any): any[];
    static addMultiMarker(arId: any, url: any, callback: any, onError: any): void;
    static writeStringToFS(target: any, string: any, callback: any): void;
    static writeByteArrayToFS(target: any, byteArray: any, callback: any): void;
    static ajax(url: any, target: any, callback: any): void;
